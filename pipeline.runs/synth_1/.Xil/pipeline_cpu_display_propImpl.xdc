set_property SRC_FILE_INFO {cfile:{E:/NKU/lesson/class file/junior1/architecture/architecture experiment/pipeline/pipeline.srcs/constrs_1/new/pipeline_cpu.xdc} rfile:../../../pipeline.srcs/constrs_1/new/pipeline_cpu.xdc id:1} [current_design]
