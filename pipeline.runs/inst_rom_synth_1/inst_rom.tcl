...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir {E:/NKU/lesson/class file/junior1/architecture/architecture experiment/pipeline/pipeline.runs/inst_rom_synth_1} -new_name inst_rom -ip [get_ips inst_rom]]
